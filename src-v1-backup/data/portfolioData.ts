...
export const PORTFOLIO_DATA = {
  personal: {
    ...
    email: "vedantbhanushali.dev@gmail.com",
  ...
  education: [
    {
      ...
      institution: "SAKEC (Shah & Anchor Kutchhi Engineering College)",
      location: "Mumbai, India",
  ...
  contact: {
    ...
    linkedin: "https://linkedin.com",
    socials: [
      { name: "Email", url: "mailto:vedantbhanushali.dev@gmail.com", handle: "vedantbhanushali.dev@gmail.com" },
